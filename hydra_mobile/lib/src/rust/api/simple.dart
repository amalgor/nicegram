...
// These functions are ignored because they are not marked as `pub`: `ensure_snapshot_writer`, `init_quota_from_config`, `shared_p2p_handle`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `NODE_STARTED`, `SHARED_P2P_HANDLE`, `SHARED_PROXY_MODE`, `SHARED_REGISTRY`
